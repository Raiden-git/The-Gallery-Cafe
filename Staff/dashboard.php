...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    if (isset($stmt)) {
        ...
        if ($stmt->execute()) {
            $_SESSION['message'] = 'Order ' . ($action == 'confirm' ? 'Confirmed' : ($action == 'cancel' ? 'Cancelled' : 'Modified')) . ' Successfully';
        } else {
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <?php if ($row['status'] == 'Pending'): ?>
                                <a href="reservation_management.php?action=confirm&id=<?php echo $row['id']; ?>" class="confirm">Confirm</a>
                                <a href="reservation_management.php?action=cancel&id=<?php echo $row['id']; ?>" class="cancel">Cancel</a>
                                <a href="reservation_management.php?action=modify&id=<?php echo $row['id']; ?>" class="modify">Modify</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endwhile; ?>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <?php if ($row['status'] == 'Pending'): ?>
                                ...
                                <a href="staff_modify_order.php?id=<?php echo $row['id']; ?>" class="modify">Modify</a>
